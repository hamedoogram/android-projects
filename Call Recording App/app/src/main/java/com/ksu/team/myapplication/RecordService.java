...
public class RecordService extends Service {
    ...
    public void onCreate() {
        ...
        super.onCreate();
        Toast.makeText(this, "Dear Hamed. service created", Toast.LENGTH_LONG).show();
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        else if (commandType == STATE_CALL_START)
        {
            ...
            try {
                recorder.prepare();
                recorder.start();
                Toast toast = Toast.makeText(this, "Call Started", Toast.LENGTH_SHORT);
                toast.show();

                manger = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                Notification notification = new Notification(R.drawable.ic_drawer, "Call Recieved", System.currentTimeMillis());
                ...
                notification.setLatestEventInfo(this, "notification title", "Hi MR. Hamed you got a notification when call ...", contentIntent);
        ...
        else if (commandType == STATE_CALL_END)
        {
            try {
                ...
                recorder.release();
                recorder = null;
                Toast toast = Toast.makeText(this, "Call Ended", Toast.LENGTH_SHORT);
                toast.show();
                Intent intent_main = new Intent(getApplicationContext(), MainActivity.class);
                intent_main.putExtra("title", phoneNumber);
                intent_main.putExtra("des",getFilename());
    ...
    private void terminateAndEraseFile()
    {
        try {
            ...
            recorder.release();
            recorder = null;
            Toast toast = Toast.makeText(this, "Call Ended Mr. Hamed!", Toast.LENGTH_SHORT);
            toast.show();
        } catch (IllegalStateException e) {
            e.printStackTrace();
        }
        ...
        Toast toast = Toast.makeText(this, "Recording Have an error. Sorry...", Toast.LENGTH_LONG);
        toast.show();
    }
